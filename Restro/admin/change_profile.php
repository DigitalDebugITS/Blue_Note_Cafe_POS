...
if (isset($_POST['ChangeProfile'])) {
  ...
  $Qry = "UPDATE rpos_admin SET admin_name = ?, Phone_number = ?, admin_password = ? WHERE admin_id = ?";
  $postStmt = $mysqli->prepare($Qry);
  $postStmt->bind_param('ssss', $admin_name, $admin_Phone, $password, $admin_id);
  $postStmt->execute();
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <div class="text-center">
                  ...
                  <div class="h5 font-weight-300">
                    <i class="ni location_pin mr-2"></i><?php echo $admin->Phone_number; ?>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div class="pl-lg-4">
                    ...
                    <div class=" col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="Phone" id="input-Phone" value="<?php echo $admin->Phone_number; ?>" name="admin_Phone" class="form-control form-control-alternative">
                          </div>
                        </div>
