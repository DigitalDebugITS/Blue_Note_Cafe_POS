...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price']) || empty($_POST['prod_quantity'])) {
    ...
    $original_quantity=$_POST['prod_quantity'];
    $prod_price = $_POST['prod_price'];

    //Insert Captured information to a database table
    $postQuery = "INSERT INTO rpos_products (prod_id, prod_code, prod_name, prod_img, prod_desc, prod_price, prod_quantity, original_quantity ) VALUES(?,?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    //bind paramaters
    $rc = $postStmt->bind_param('ssssssss', $prod_id, $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_quantity,$original_quantity);
    $postStmt->execute();
      ...
      <div class="row">
        <div class="col">
          <div class="card shadow">
            ...
            <h1 style="color: black;">Fill in All Fields<span style="color: red;">   (DO NOT ADD EXISTING PRODUCTS)</span></h1>
