              ...
              <form method="POST">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="staff_number" class="form-control" value="<?php echo "BNCAFE"?>-<?php echo $beta; ?>">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addStaff" value="Add Staff" class="btn " value="">
                  </div>
                </div>
              </form>
            </div>
